...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.default.Schema.Types.ObjectId, ref: 'Gist' }),
    __metadata("design:type", String)
], Transaction.prototype, "gistId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.default.Schema.Types.ObjectId, ref: 'Plan' }),
    __metadata("design:type", String)
], Transaction.prototype, "planId", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.default.Schema.Types.ObjectId, ref: 'ExtendPlan' }),
    __metadata("design:type", String)
], Transaction.prototype, "extendPlanId", void 0);
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
